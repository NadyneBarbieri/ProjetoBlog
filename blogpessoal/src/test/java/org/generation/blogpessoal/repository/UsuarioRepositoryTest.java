...
public class UsuarioRepositoryTest {
	...
	void start(){
		...
		//inserir as informaçoes pra cadastrar usuario na mesma ordem que estao no constructor de usuario, na usuariomodel
	...
	public void deveRetornarTresUsuarios() {
		...
		assertTrue(usuario.get(0).getNome().equals("João da Silva"));

		assertTrue(usuario.get(1).getNome().equals("Manuela da Silva"));

		assertTrue(usuario.get(2).getNome().equals("Adriana da Silva"));
